...
3. **Validation Commands**: Format, validate, security scan (checkov), plan
...
- Organized files: main.tf, variables.tf, outputs.tf, locals.tf
...
- [ ] Variables: Documented, descriptions, types, validation rules
...
2. `tflint` for linting
3. Security scan: `checkov -d .`
